...
namespace AdminManageEmployees.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public SystemCodesController(AdminDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SystemCodeId,Systemcode,SystemName,SystemDescription,Id,CreateeOn,ModifiedBy,ModifiedOn")] SystemCode systemCode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("SystemCodeId,Systemcode,SystemName,SystemDescription,Id,CreateeOn,ModifiedBy,ModifiedOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
